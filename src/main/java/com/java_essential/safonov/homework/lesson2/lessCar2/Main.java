...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Машина3 " + car);
        System.out.println("Машина1 " + car1);
        System.out.println("Машина2 " + car2);
        System.out.println("Машина4 " + car3);
        System.out.println("Машина5 " + car4);
